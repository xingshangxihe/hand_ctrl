...
> 当前版本：**v2.6（捏合单击/双击 + 三指右键 + 双指V拖拽方案）**——开掌锁定，掌心相对位移控制鼠标，捏合单击/双击，三指右键，双指V拖拽。
>
> v1.0（六手势方案）已废弃：握拳短按、OK、竖拇指、食指滑动等姿态手势。
> v2.6 保留：开掌锁定/解锁 + 掌心相对位移 + 捏合单击/双击 + 三指右键 + 双指V拖拽。
...
- [x] **捏合单击/双击 + 拇指小指捏合右键 + 双指V拖拽**：各动作完全分离，判定均用比例法
